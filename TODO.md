...
- [ ] Подключить поддержку через Telegram-бота (двусторонний чат)
- [ ] Сохранять историю сообщений пользователей в базе данных
- [ ] Реализовать админский интерфейс для просмотра диалогов
- [ ] Реализовать ответы администратора пользователям через админку
